...
VERSION = 1.0.0.0
QMAKE_TARGET_COMPANY = Gorkem Tok
QMAKE_TARGET_PRODUCT = GVideoPlayer
QMAKE_TARGET_DESCRIPTION = Media Player For Playing Video(s)
QMAKE_TARGET_COPYRIGHT = copyright 2021 Gorkem Tok
